...
export const BoardSide = ({
  ...
  const monsterRow = (
    <div className="flex justify-center gap-[2px] sm:gap-3 mt-1 sm:mt-4">
  ...
  const spellRow = (
    <div className="flex justify-center gap-[2px] sm:gap-3">
  ...
  return (
    <div className={`flex flex-col gap-1 sm:gap-2 transition-all ${isOpponent ? "rotate-180 scale-95" : ""}`}>
      {monsterRow}
      {spellRow}
    </div>
  );
