...
export const BoardGutter = ({ onDraw, type }: BoardGutterProps) => {
  ...
  return (
    <div
      className={`flex flex-col h-full w-9 sm:w-20 items-center justify-end ${isOpponent ? "rotate-180 mb-2 sm:mb-4" : "mt-2 sm:mt-4"}`}
    >
      <div className="flex flex-col gap-1 sm:gap-2">
        <div className="w-9 h-12 sm:w-20 sm:h-24 bg-zinc-800/40 border-2 border-zinc-700 rounded-lg relative flex items-center justify-center flex-col">
        ...
        <div
          ...
          className={`w-9 h-12 sm:w-20 sm:h-24 bg-orange-900 border-2 border-orange-700 rounded-lg shadow-[0_4px_0_#431407] sm:shadow-[0_6px_0_#431407] transition-all flex items-center justify-center group flex-col
