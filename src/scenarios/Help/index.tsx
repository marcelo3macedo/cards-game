        ...
        <div className="space-y-6">
          <div className="bg-orange-950/20 border border-orange-500/20 p-4 rounded-xl">
            ...
            <p className="text-zinc-400 text-sm leading-relaxed">
              São sua principal força de ataque. Possuem níveis (estrelas) e pontos de ATK/DEF.
              Podem ser invocados em modo de ataque ou defesa.
            </p>
          </div>
          <div className="bg-emerald-950/20 border border-emerald-500/20 p-4 rounded-xl">
            ...
            <p className="text-zinc-400 text-sm leading-relaxed">
              Ativadas da sua mão durante o seu turno para conceder bônus, destruir cartas ou
          ...
          <div className="bg-pink-950/20 border border-pink-500/20 p-4 rounded-xl">
            ...
            <p className="text-zinc-400 text-sm leading-relaxed">
              Devem ser baixadas no campo primeiro. Podem ser ativadas no turno do oponente para
              surpreendê-lo e bloquear ataques.
            </p>
          </div>
        </div>
      ),
          ...
          <div className="flex gap-4 items-start">
            ...
            <div>
              ...
              <p className="text-zinc-400 text-xs">
                Usa os pontos de ATK. Se vencer uma batalha, causa dano aos Life Points (LP) do
                oponente.
              </p>
            </div>
          </div>
          <div className="flex gap-4 items-start">
            <div className="bg-zinc-800 p-3 rounded-lg rotate-90">
              <Shield className="text-blue-500" />
            </div>
            <div>
              <h4 className="font-bold text-white">Modo de Defesa (Horizontal)</h4>
              <p className="text-zinc-400 text-xs">
                Usa os pontos de DEF. Protege seus LP: se o monstro for destruído em defesa, você
                não perde pontos de vida.
              </p>
            </div>
          </div>
        </div>
      ...
      content: (
        <div className="space-y-4 text-sm text-zinc-400">
          <p className="bg-white/5 p-3 rounded-lg border-l-4 border-red-500">
            <strong className="text-white">Cálculo de Dano:</strong> Quando seu ATK é maior que o
            ATK/DEF do alvo.
          </p>
          <ul className="list-disc list-inside space-y-2 ml-2">
            <li>Contra Ataque: Dano = Seu ATK - ATK Inimigo.</li>
            <li>
              Contra Defesa: Alvo é destruído se Seu ATK {">"} DEF Inimiga (sem dano ao oponente).
            </li>
            <li>
              Ataque Direto: Se o oponente não tem monstros, você ataca os LP dele diretamente com
              seu ATK total!
            </li>
          </ul>
        </div>
      ...
      content: (
        <div className="flex flex-col items-center text-center py-6">
          ...
          <p className="text-zinc-400 max-w-xs">
            Ambos os jogadores começam com <span className="text-white font-bold">8000 LP</span>. O
            primeiro a chegar a <span className="text-red-500 font-bold">0 LP</span> perde o duelo!
          </p>
          <div className="mt-6 p-3 bg-blue-500/10 border border-blue-500/20 rounded-lg text-xs italic">
            Dica: Se o baralho de um jogador acabar e ele não puder comprar cartas, ele também
            perde!
          </div>
        </div>
      ),
    ...
    <div className="h-screen w-screen bg-zinc-950 flex flex-col text-white overflow-hidden font-sans relative">
          ...
          {topics.map((topic) => (
            ...
            >
              <div className="flex items-center gap-3">
                <span className={activeTopic === topic.id ? "text-black" : topic.color}>
                  {topic.icon}
                </span>
      ...
      <footer className="h-12 bg-blue-600 flex items-center justify-center px-10">
        <div className="flex items-center gap-2 text-white font-bold text-[10px] uppercase tracking-widest">
          <Info size={14} />
          <span>
            Dica: Clique com o botão direito em qualquer carta durante o duelo para ver seus
            detalhes.
          </span>
        </div>
      </footer>
